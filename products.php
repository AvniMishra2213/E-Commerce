    ...
    <body>
        ...
        <div class="container" id="content">
            ...
            <div class="row text-center" id="cameras">
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            <h3>Instax Mini Neo</h3>
                            <p>Price: Rs. 58,000.00</p>
                            <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                            } else {
            ...
            <div class="row text-center" id="dresses">
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            <h3>Fastrack Digital </h3>
                            <p>Price: Rs. 3654.00 </p>
                            <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                            } else {
            ...
            <div class="row text-center" id="dresses">
              ...
              <div class="row text-center" id="boots">
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/56.jpg" alt="">
                        <div class="caption">
                            <h3>Fauxe Suede Boots</h3>
                            <p>Price: Rs. 3000.00 </p>
                            <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
...
<div class="row text-center" id="sunglasses">
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            <h3>Cat Eye Sunglass</h3>
                            <p>Price: Rs. 1224.00 </p>
                            <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                            } else {
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            <h3>Octagon Shades</h3>
                            <p>Price: Rs. 1140.00 </p>
                            <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                            } else {
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            <h3>Vintage Cat Eye</h3>
                            <p>Price: Rs. 1389.00 </p>
                            <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                            } else {
                ...
                <div class="row text-center" id="earrings">
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/72.jpg" alt="">
                        <div class="caption">
                            <h3>Green Marquise </h3>
                            <p>Price: Rs. 649.00 </p>
                            <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
